        ...
        <div className='vapi-header-card'>
          ...
          <div className='vapi-cover-wrapper'>
            ...
            <div className="vapi-mic-wrapper relative">
              ...
              {/*Right Side title, author, persona... */}
              <div className='flex flex-col gap-4 flex-1'>
              {/**Title & author */}
                <div>
                  <h1 className='text-2xl sm:text-3xl font-bold font-serif text-[#212a3b] mb-1'>{book.title}</h1>
                ...
                {/**status dispaly*/}
                 <div className='vapi-status-indicator'>
                  <span className={`vai-status-dot ${statusDisplay.color}`} />
