...
const VoiceSelector = <T extends FieldValues>({ name, value, onChange, disabled, invalid, className }: VoiceSelectorProps<T>) => {
    return (
                    ...
                    <div className="voice-selector-options">
                        {voiceCategories.male.map((voiceId) => {
                            ...
                            return (
                                ...
                                >
                                    <RadioGroupItem value={voiceId} id={voiceId} className="sr-only" aria-invalid={invalid} />
